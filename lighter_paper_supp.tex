...
...
\end{verbatim}
And we have 48 such cores.

\section*{Supplementary Note 5: Command lines}
The command lines that we used in all the experiments are available in https://github.com/mourisl/Lighter\_paper. See the README.md there.
